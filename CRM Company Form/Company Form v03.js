		...
		if( sLabel != null && sLabel.length > 0 )
		{
			...
			{		
				...
				if( DebugModeCompany )
				{
					...
					window.alert( "typeof myCheckboxValue\t" + typeof myCheckboxValue +  "\ntypeof sLabel\t" + typeof sLabel );
					if( prev != null ) window.alert( "typeof prev\t" + typeof prev + "\nprev.indexOf( sLabel )\t" + prev.indexOf( sLabel ) + "\nprev.replace( sLabel, blank )\t" + prev.replace( sLabel, "" ));
				}			
				...
				{	/* myCheckboxValue == true then concatenate sLabel */
					if( DebugModeCompany )
